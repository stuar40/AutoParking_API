...
const parqueo = {
    ...
    addParqueo: function(usr_parqueo, callback) {
        ...
        return db.query("Insert into usr_parqueo values(?,?,?,?,?,?,?,?)", [usr_parqueo.id_parqueo, usr_parqueo.nombre_parqueo, usr_parqueo.direccion_parqueo, usr_parqueo.lugares_disponibles, usr_parqueo.total_lugares, usr_parqueo.user_parqueo,usr_parqueo.pass_parqueo,  usr_parqueo.datos_iddatos], callback)
    },
    ...
    updateParqueo: function(parqueoId, usr_parqueo, callback) {
        ...
        return db.query("UPDATE usr_parqueo SET nombre_parqueo=?, direccion_parqueo=?, lugares_disponibles= ?, total_lugares=?, user_parqueo=?, pass_parqueo=? , datos_iddatos=?  WHERE id_parqueo=? ", [usr_parqueo.nombre_parqueo, usr_parqueo.direccion_parqueo, usr_parqueo.lugares_disponibles, usr_parqueo.total_lugares, usr_parqueo.user_parqueo, usr_parqueo.pass_parqueo,
